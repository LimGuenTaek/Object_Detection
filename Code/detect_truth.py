...
if __name__ == '__main__':
    ...
    for i in range(len(path)):
      if i < 1455:
        images.append("/content/drive/MyDrive/KAIST_Original/KAIST_dataset/"+path[i][:6]+path[i][:11]+"visible/"+path[i][11:17]+".jpg")
      else :
        images.append("/content/drive/MyDrive/KAIST_Original/KAIST_dataset/"+path[i][:11]+"visible/"+path[i][11:17]+".jpg")
        
    with open("/content/drive/MyDrive/KAIST_Original/Json/kaist_annotations_test20.json", 'r') as f: ## ground truth 값 읽어오기
    ...
    while idx<=4238:
      ...
      image.save("/content/drive/MyDrive/KAIST_Double/RGB_Truth/"+str(image_id)+".jpg",'JPEG')
      cnt=cnt+1
    print(cnt)
