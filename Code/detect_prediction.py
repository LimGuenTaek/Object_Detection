...
if __name__ == '__main__':
    ...
    for idx in range(len(images)):
      original_image = Image.open(images[idx], mode='r')
      original_image = original_image.convert('RGB')
      detect(original_image, min_score=0.2, max_overlap=0.5, top_k=200).save("/content/drive/MyDrive/MyCode/Prediction(baseline)/"+str(idx)+".jpg",'JPEG')