...
annType = 'bbox'
JSON_GT_FILE = os.path.join('/content/drive/MyDrive/MyCode/Json/kaist_annotations_test20.json')
...
if __name__ == '__main__':
    ...
    test_json_path = '/content/drive/MyDrive/MyCode/Json/prediction_example.json'
